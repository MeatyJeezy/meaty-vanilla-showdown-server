...
export const Formats: FormatList = [
	...
	},
	{
		...
		ruleset: ['Pixelmon Monotype'/*'Standard', '!OHKO Clause', '!Obtainable', 'Min Source Gen = 8', 'Limit One Restricted', 'Terastal Clause', 'Mega Rayquaza Clause', 'Adjust Level = 100', 'Max Level = 100', 'Default Level = 100', 'Same Type Clause'*/],
		restricted: ['Restricted Legendary', 'Mythical'],
		banlist: [
			'ND AG', 'Zacian', 'Zacian-Crowned',
		],
	},
	// S/V Singles
	///////////////////////////////////////////////////////////////////

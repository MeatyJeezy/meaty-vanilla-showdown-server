export const Rulesets: {[k: string]: ModdedFormatData} = {
	pixelmonmonotype: {
		...
		ruleset: [
			'Dynamax Or Mega', 'Team Preview', 'Sleep Clause Mod', 'Species Clause', 'Evasion Abilities Clause','Evasion Items Clause', 'Evasion Moves Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod', 
			'Limit One Restricted', 'Terastal Clause', 'Mega Rayquaza Clause', 'Adjust Level = 100', 'Max Level = 100', 'Default Level = 100', 'Item Clause'
			//'Min Source Gen = 8',
		],
	},
	standard: {
